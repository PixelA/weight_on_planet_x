 ...
 */
  ...
  void handleRadioValueChanged(int value) {
    setState(() {
      ...
      switch (radioValue) {
        case 0:
          _finalResult = calculatedWeight(_weightController.text, 0.06);
          _formattedText = "Your weight on Pluto is ${_finalResult.toStringAsFixed(1)}";
          break;
        case 1:
          _finalResult = calculatedWeight(_weightController.text, 0.38);
          _formattedText = "Your weight on Mars is ${_finalResult.toStringAsFixed(1)}";
          break;

        case 2:
          _finalResult = calculatedWeight(_weightController.text, 0.91);
  ...
  double calculatedWeight(String weight, double multiplier) {
